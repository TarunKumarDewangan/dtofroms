...
import { Card, Table, Badge, Spinner, Button, Modal, Alert } from 'react-bootstrap';
                                    ...
                                    <tr key={ns.id} className="border-bottom border-secondary border-opacity-10">
                                        ...
                                        <td className="py-3">
                                            {(ns.combined_works || []).map((w, i) => (
                                                <Badge key={i} bg="secondary" className="me-1 mb-1" style={{ fontSize: '10px' }}>
                                                    {w.work_code?.replace('_', ' ')}
                                                </Badge>
                                            ))}
                                        </td>
